...
class L0Dense(nn.Module):
    ...
    def __init__(self, feature, embed_dim, weight_decay=0.0005, droprate=0.5, bias=False,
                 temperature=2. / 3., lamba=1, local_rep=False, device='cpu', **kwargs):
        """
        feature: input dimension
            yelp:
            u的feature是u2e的维度是2614
            i的feature是i2e的维度是1286
        ...
        self.floatTensor = torch.FloatTensor if str(self.device).__eq__('cpu') else torch.cuda.FloatTensor
